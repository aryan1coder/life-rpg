...
import { Sparkles, ArrowRight, Lock, Mail, AlertCircle, AlertTriangle } from 'lucide-react';
        ...
        {!isConfigured && (
          <div className="mb-6 p-4 rounded-2xl bg-amber-500/10 border border-amber-500/20 text-left">
            ...
            <p className="text-xs text-text-secondary leading-relaxed mb-3">
              The command deck requires an active connection to your Supabase project. Authentication cannot proceed until environment variables are configured in <code className="text-primary font-mono text-[11px]">.env.local</code>.
            </p>
